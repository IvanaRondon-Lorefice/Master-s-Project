            ...
            for threshold in Threshold:
                ...
                for instance in range(100):
                    ...
                    if algorithm == "SWING":    
                        ...
                        mean_importance_file = pd.read_csv(f"networks_in_out_degree_{degree}_num_nodes_{nodes}/Results_{nodes}genes_100insilico_networks/mean_importance_SWING_{instance}.tsv", sep ="\t")
                        mean_importance_file_rand = pd.read_csv(f"networks_in_out_degree_{degree}_num_nodes_{nodes}/Results_{nodes}genes_100insilico_networks_rand/mean_importance_SWING_{instance}_rand.tsv", sep ="\t")
                        ...
                        if (nodes == 10) | (nodes == 20):
                            mean_importance_file = pd.read_csv(f"networks_in_out_degree_4_num_nodes_{nodes}/Results_{nodes}genes_100insilico_networks/mean_importance_dynGENIE3_{instance}", sep ="\t").sort_values(by=["Cause Gene", "Effect Gene"])
                            
                        else:
                            mean_importance_file = pd.read_csv(f"networks_in_out_degree_4_num_nodes_{nodes}/Results_{nodes}genes_100insilico_networks/mean_importance_dynGENIE3_{instance}.tsv", sep ="\t", names = header_list).sort_values(by=["Cause Gene", "Effect Gene"])
                        
                        mean_importance_file_rand = pd.read_csv(f"networks_in_out_degree_4_num_nodes_{nodes}/Results_{nodes}genes_100insilico_networks_rand/mean_importance_dynGENIE3_{instance}_rand.tsv", sep ="\t", names = header_list).sort_values(by=["Cause Gene", "Effect Gene"])
