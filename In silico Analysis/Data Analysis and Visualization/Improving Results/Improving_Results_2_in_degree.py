        ...
        for algorithm in Algorithm:
            for threshold in Threshold:
                ...
                for instance in range(100):
                    ...
                    gold_standard = pd.read_csv(f"networks_in_out_degree_{degree}_num_nodes_{nodes}/Networks_in_out_degree_{degree}_num_nodes_{nodes}/in_and_out_degree_{degree}_num_nodes_{nodes}_case_{instance}/goldstandard_signed_{instance}_goldstandard.tsv", sep="\t", names= header_list)
